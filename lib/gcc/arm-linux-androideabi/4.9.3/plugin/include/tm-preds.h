/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/jenkins/workspace/linaro-android_toolchain-4.9-2015.04/build/objdir/../build/../gcc/gcc-linaro-snapshot-4.9-2015.04/gcc/config/arm/arm.md'.  */
